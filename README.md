...
# ☁️ *Script Rendez Go™ version 2.0* ☁️

VPS AutoScript for Ubuntu and Debian Distros. Comes with pre-installed tunneling software. See below for a list of pre-installed programs.
...
_It will install the version of Script Rendez Go that is compatible with your VPS's operating system and version._
...
_The version can be manually chosen for your virtual private server if universal installation fails._ 
##



## Command: _menu_ 
`Use this to access Scrip Rendez Go Menu through vps terminal`
#
